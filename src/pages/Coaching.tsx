  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 relative overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23d4af37' fill-opacity='0.05'%3E%3Cpath d='M30 30c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10-10-4.477-10-10zm-10 0c0-5.523-4.477-10-10-10S0 24.477 0 30s4.477 10 10 10 10-4.477 10-10z'/%3E%3C/g%3E%3C/svg%3E")`,
        }}></div>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-amber-700 max-w-3xl mx-auto leading-relaxed">
              Visionaries dedicated to blending ancient Vedic wisdom with modern education excellence
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-orange-100">
                {/* Founder Image Section */}
                <div className="relative h-64 bg-gradient-to-br from-orange-400 to-amber-500 overflow-hidden">
                ...
                <div className="p-8">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-orange-600 font-semibold mb-1">Founder & Director</p>
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    An IIT Delhi alumnus with a passion for revolutionizing education. Dr. Sharma combines 
                    technical expertise with ancient Vedic principles to create a unique learning environment 
                    that nurtures both academic excellence and spiritual growth.
                  </p>
                  
                  {/* Expertise Tags */}
                  <div className="flex flex-wrap gap-2 mb-6">
                    {["IIT Delhi", "Ph.D. Education", "Vedic Studies", "Research"].map((tag, index) => (
                  ...
                  {/* Quote */}
                  <div className="border-l-4 border-orange-400 pl-4 italic text-amber-800">
                    "Education is not just about filling minds with facts, but about awakening souls with wisdom."
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-orange-100">
                {/* Co-founder Image Section */}
                <div className="relative h-64 bg-gradient-to-br from-amber-400 to-yellow-500 overflow-hidden">
                  <div className="absolute inset-0 bg-black/20"></div>
                ...
                <div className="p-8">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-amber-600 font-semibold mb-1">Co-founder & Academic Head</p>
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    A distinguished medical professional and educationist with extensive experience in 
                    competitive exam coaching. Dr. Nair brings a holistic approach to education, emphasizing 
                    mental well-being alongside academic achievement.
                  </p>
                  
                  {/* Expertise Tags */}
                  <div className="flex flex-wrap gap-2 mb-6">
                    {["AIIMS Delhi", "M.D. Medicine", "Psychology", "Mentoring"].map((tag, index) => (
                  ...
                  {/* Quote */}
                  <div className="border-l-4 border-amber-400 pl-4 italic text-amber-800">
                    "True education heals the mind, nourishes the soul, and transforms the individual."
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-orange-600 to-amber-600 rounded-3xl p-8 shadow-xl">
              ...
              <p className="text-orange-100 max-w-2xl mx-auto text-lg leading-relaxed">
                To create a new generation of leaders who are not only academically brilliant 
                but also rooted in cultural values and spiritual wisdom, ready to serve humanity 
